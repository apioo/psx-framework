...
EOF
    ...
    private function findProperServiceName(InputInterface $input, SymfonyStyle $io, SymfonyContainerBuilder $builder, string $name, bool $showHidden): string
    {
        $name = ltrim($name, '\\');
    ...
    private function findProperTagName(InputInterface $input, SymfonyStyle $io, SymfonyContainerBuilder $builder, string $tagName): string
    {
    ...
    private function findServiceIdsContaining(SymfonyContainerBuilder $builder, string $name, bool $showHidden): array
    {
    ...
    private function findTagsContaining(SymfonyContainerBuilder $builder, string $tagName): array
    {

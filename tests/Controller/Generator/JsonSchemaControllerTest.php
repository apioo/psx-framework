...
use PSX\Framework\Controller\Generator\JsonSchemaController;
...
/**
 * JsonSchemaControllerTest
 *
 * @author  Christoph Kappestein <christoph.kappestein@gmail.com>
 * @license http://www.apache.org/licenses/LICENSE-2.0
 * @link    http://phpsx.org
 */
class JsonSchemaControllerTest extends ControllerTestCase
{
    public function testIndex()
    {
        $response = $this->sendRequest('/jsonschema/1/api', 'GET', ['Accept' => 'application/json']);
    ...
    {
        $response = $this->sendRequest('/jsonschema/1/*', 'GET', ['Accept' => 'application/json']);
        $json     = (string) $response->getBody();
    ...
    {
        return array(
            [['GET'], '/jsonschema/:version/*path', JsonSchemaController::class],
